...
export default function ContractorLoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Check if this user has a contractor record
    ...
    if (user) {
      ...
      if (!contractor) {
        setError('Your account is not linked to a contractor record. Please contact Sano.')
    ...
    <div className="min-h-screen flex items-center justify-center bg-sage-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          />
          <p className="text-sage-600 text-sm">Contractor Portal</p>
        </div>
