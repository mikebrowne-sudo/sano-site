      ...
      <section className="section-padding py-10 md:py-14 bg-gradient-to-b from-white to-sage-50">
        <div className="container-max">
          ...
          <p className="text-center text-gray-600 max-w-xl mx-auto mb-8">
            From regular home maintenance to deep one-off cleans, we have a service for every need. All delivered by vetted, insured cleaners using carefully chosen products.
          </p>
