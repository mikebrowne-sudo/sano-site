  ...
  function submit() {
    ...
    startTransition(async () => {
      const res = await signEmploymentAgreement({
        token, fullName, address, irdNumber: ird, bankAccount: bank, taxCode, kiwisaverChoice: kiwisaver, signedName,
      })
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        <label className="flex flex-col gap-1 sm:col-span-2"><span className="text-[11px] font-medium text-sage-500">Home address</span>
      ...
      <div className="border-t border-sage-100 pt-4 space-y-3">
        ...
        <label className="flex items-start gap-2 text-sm text-sage-700">
          ...
          <span>I have read, understood, and agree to this Casual Employment Agreement.</span>
        </label>
