  ...
  return (
    <div className="tnum">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-8 flex flex-wrap items-center gap-2 text-sm">
        ...
        <Link href="/portal/finance/contractor-tax-remediation" className="inline-flex items-center gap-1.5 border border-sage-200 text-sage-700 px-3 py-1.5 rounded-lg hover:bg-sage-50 transition-colors">Contractor tax remediation →</Link>
        <Link href="/portal/finance/job-margins" className="inline-flex items-center gap-1.5 border border-sage-200 text-sage-700 px-3 py-1.5 rounded-lg hover:bg-sage-50 transition-colors">Job margins →</Link>
