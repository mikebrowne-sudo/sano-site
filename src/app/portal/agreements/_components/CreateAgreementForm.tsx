  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <label className="flex flex-col gap-1"><span className="text-[11px] font-medium text-sage-500">{isContractor ? 'Contractor rate $ (per hour, incl. GST)' : 'Hourly rate $ (incl. 8% hol.)'}</span>
