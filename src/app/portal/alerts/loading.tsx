// Skeleton shown while the alerts list RSC fetches data. Neutral list
// shape (header + filter + table) consistent with the quotes / jobs /
// invoices skeletons so cross-page navigation feels instant.

export default function AlertsListLoading() {
  return (
