...
// with reason modal, re-enable.
//
// Phase 5.5.10 fix — the status helpers (Status type, STATUS_LABEL,
// STATUS_BADGE, clientAccessStatus) moved to ./access-shared so the
// server-side ClientAccessPanel can import them safely. Re-exported
// here as a back-compat surface for any callsite still importing from
// the old path.
...
import {
  ...
  clientAccessStatus as _clientAccessStatus,
  type AccessStatus,
} from './access-shared'
...
export const clientAccessStatus = _clientAccessStatus
