...
export async function buildAgreementScheduleSnapshot(
  ...
  const { data: rows } = await supabase
    ...
    .select('id, name, customer_client_id, classification, service_type, service_address, start_date, frequency, term, payment_method, payment_basis, rate_basis, agreed_amount, notice_period, price_review_date, closure_treatment, additional_work_approval, equipment_products, equipment_arrangement, product_arrangement, tax_treatment, status, effective_from, updated_at')
